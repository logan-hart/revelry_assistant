...
function PopularEvent({popEvent}) {
    const {id, name, lineup, startDate, images, ticketsSold, venue} = popEvent
    ...
    return (
        <div className="popular-event-container">
            <Link to={`/events/${id}`}><div className='popular-img'><img id="large-event-poster"src={images}/></div></Link>
